...
const projects = [
  {
    ...
    image: 'petshop', // Replace with actual image path
  ...
  return (
    <section id="portfolio" className="min-h-screen py-20 text-white w-full overflow-hidden">
      {/* Background Glow */}
            ...
            >
              {techStack.map((tech, index) => (
                <motion.div
                  ...
                  className="group relative overflow-hidden rounded-xl bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700/50 p-6 hover:border-purple-500/50 transition-all duration-300"
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-blue-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
